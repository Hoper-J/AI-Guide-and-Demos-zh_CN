...
>
> [代码文件下载](https://github.com/Hoper-J/LLM-Guide-and-Demos-zh_CN/blob/master/Demos/5.%20尝试部署你的第一个LLM大语言模型.ipynb)
...
大型语言模型（LLMs）通常拥有数十亿甚至上千亿的参数，这对显存要求很高，为了方便学习和复现，我们选择参数量较小的模型（如小型 GPT、BERT 等）进行演示，你应该在任何机器上进行学习。
...
![image-20240914113907333](./assets/image-20240914113907333.png)
