...
>
> 代码文件下载：[notebook](https://github.com/Hoper-J/LLM-Guide-and-Demos-zh_CN/blob/master/Demos/5.%20尝试部署你的第一个LLM大语言模型.ipynb), [app_fastapi.py](https://github.com/Hoper-J/LLM-Guide-and-Demos-zh_CN/blob/master/Demos/app_fastapi.py), [app_flask.py](https://github.com/Hoper-J/LLM-Guide-and-Demos-zh_CN/blob/master/Demos/app_flask.py)
