...
| [18. ✍️](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Guide/18.%20.md) | LLM       | 涉及从零开始的LLM部署和微调。<br />目前拆分了量化的前置知识以理解模型选择，可以先阅读 [d. 模型量化技术概述及 GGUF/GGML 文件格式解析](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Guide/d.%20模型量化技术概述及%20GGUF%3AGGML%20文件格式解析.md)。<br />未完待续.. |                                                              |
...
| [d. 模型量化技术概述及 GGUF/GGML 文件格式解析](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Guide/d.%20模型量化技术概述及%20GGUF%3AGGML%20文件格式解析.md) | 在遇到 GGUF 相关的问题时查看，或许能够解决你的困惑。<br />例如：Q4_0、Q4_1、Q4_K 和 Q4_K_M 的区别。 |
