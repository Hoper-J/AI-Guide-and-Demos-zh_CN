...
> - ...
>
> 这篇文章会解决这些问题，并通过使用 Transformers 和 Llama-cpp-python 分别进行部署演示，帮助你更好地理解和掌握，本文对应于 Transformers，[19b]() 对应于 Llama-cpp-python。
>
...
如果你对 GGUF 文件的部署或者 Llama-cpp-python 的使用感兴趣，继续阅读 [19b]()。
