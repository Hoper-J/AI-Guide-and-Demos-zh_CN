...
>
> **最近一次更新时间**：2026-07-03，此时国外最新的模型参考组为：Fable-5 | Opus 4.8｜GPT 5.5｜Gemini 3.5-flash，主要针对 Opus 4.8 和 GPT 5.5 进行推荐。
>
> **关于 Fable-5**：有幸在下架之前体验了 4,000 刀的 fable-5，给我的感觉非常惊艳：体感 fable vs opus == opus vs sonnet，很多年初的新概念都能快速上手并迅速出一个 demo。刚好还有 3 个 pro 的七天免费体验码，有需要的同学可以自取（[#23](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/discussions/23)）。
...
> ~~从 2025-12-18 发布的 GPT 5.2 Codex 开始，可以明显感受到 GPT 在智商、知识广度和新鲜度上强于当时的 Claude Opus 4.5，同样一次对 Supabase 的从零部署开发，Opus 4.5 需要反复撤销校正，而 GPT 5.2 Codex 可以做到 Plan 后直接达成预期。2026-02-05，Opus 4.6 发布后，这种体感一度有所改观，但在 2026-03-05 GPT 5.4 发布之后，GPT 又重新给了我这样的感觉。~~ Claude Opus 4.8 已来，这些“流言蜚语”可以退避了。

下表是我在实际体验后给出的订阅建议，可以根据自身实际情况参考，希望能够对你有所帮助（2026-07-07之前，全部编程和科研场景都仅推荐 Claude，因为这期间 Fable-5 可用）：

| 使用场景 | 推荐 | 备注 |
| --- | --- | --- |
| 熟悉业务，能看懂代码，追求开发响应速度，热衷于 review 代码 | Claude | Claude Code 就是目前最好的 CLI 产品设计，没有之一。<br />在你熟悉的业务领域里，项目推进速度上：你 + Claude >> 你 + GPT |
| 熟悉业务，能看懂代码，经常在长上下文（>200k）的环境下工作 | Claude | 实际体验下来，Codex 在接近 200k 上下文后，指令遵循能力存在问题，需要反复确认（去年就已经存在）。另外，目前 Codex 版本的 GPT 5.5 仅支持 252k 上下文。 |
| 科研论文 & 比赛 | Claude | 预算 100\$ 及以上也可以选 GPT，GPT Pro 能够完美满足你的需求，但很可能存在用量浪费 |
| 最近一年比较新的开源项目/协议的使用和开发 | Claude | Opus 4.8 |
| Vibe Coding，不太懂代码 | Claude | 同上 |
| 多人拼车/龙虾/Opencode/反代 | GPT | Claude 会封号 |
| 非代码场景，通用的知识学习，文章撰写 | GPT/Claude |  |
| 习惯图形界面而非命令行界面 | Claude | 即便 Codex 有 GUI，但在 Opus 4.8 面前，或许我们也可以选择 Claude Desktop |
| 预算有限（20\$）/ **新手** | 都可以 | Codex 的桌面端版本对新手来说会更友好。 |
| 对生图真实感有需求 | GPT | gpt-image-2 效果极其惊艳。 |
| 需要 Google 的生态 | Gemini | Gemini 3.1 Pro 的上线扭转了我对它的印象，写视频脚本的能力也很不错。<br />但并没有使用 Gemini 完整测试开发过一个项目，所以不做更多的描述。 |

P.S. 如果后续新 GPT 5.6 推出，而 Claude 没有同步开放新模型，那么除了前两种和最后两种场景外，我会更推荐订阅 GPT。
