...
>
> **最近一次更新时间**：2026-07-27，此时国外最新的模型参考组为：Fable 5 | Opus 5｜GPT 5.6｜Gemini 3.5-flash，主要针对 Claude 和 GPT 进行对比推荐。
>
...
P.S. 在 Fable 5 面向 20\$ 订阅用户关闭后，准备修改文章在对应价位仅推荐 GPT，没想到 Anthropic 直接甩出 Opus 5，官方纸面宣传数据上来看，效果 > Fable 5（全面超过存疑，在阅读完 system card 后如果有见解会进行同步）。或许这段时间是最不用纠结的：如果能够订阅 Claude（iOS 不担心封，因为可以直接退款）就直接选择它。
...
>
> **2026-07-08 补充**：GPT 目前实测多个账户 Pro 200\$ 的周额度为 2200\$ 左右，有一定的下滑。
