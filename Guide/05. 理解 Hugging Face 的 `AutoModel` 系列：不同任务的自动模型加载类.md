...
>
> [notebook 代码下载](https://github.com/Hoper-J/LLM-Guide-and-Demos-zh_CN/blob/master/Demos/04.%20Hugging%20Face%20AutoModel%20示例合集.ipynb)

## 目录

1. [`AutoModel` 系列概述](#automodel-系列概述)
2. [主要的 `AutoModel` 类及其用途](#主要的-automodel-类及其用途)
3. [选择合适的 `AutoModel` 类](#选择合适的-automodel-类)
4. [实际代码示例](#实际代码示例)
