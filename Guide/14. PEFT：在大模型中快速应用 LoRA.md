...
>如果对 LoRA 还没有一个直观的概念，可以回看这篇文章：[《3. 认识 LoRA：从线性层到注意力机制》](https://github.com/Hoper-J/AI-Guide-and-Demos-zh_CN/blob/master/Guide/03.%20进阶指南：自定义%20Prompt%20提升大模型解题能力.md)。
>
