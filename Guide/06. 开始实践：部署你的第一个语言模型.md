...
>
> 代码文件下载：[Notebook](../Demos/05.%20尝试部署你的第一个语言模型.ipynb), [app_fastapi.py](../Demos/app_fastapi.py), [app_flask.py](../Demos/app_flask.py)
...
- `torch`：PyTorch，深度学习框架，用于加载和运行模型，默认已安装。
